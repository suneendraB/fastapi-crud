...
def get_student_by_id(student_id: int):
    return student_repositories.get_student_by_id(student_id)


def create_student(student_data:dict):
    return student_repositories.create_student(student_data)


def update_student(student_id: int, updated_data: dict):
    return student_repositories.update_student(student_id, updated_data)


def delete_student(student_id: int):
    return student_repositories.delete_student(student_id)
